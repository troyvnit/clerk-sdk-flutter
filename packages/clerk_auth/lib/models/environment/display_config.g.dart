...
DisplayConfig _$DisplayConfigFromJson(Map<String, dynamic> json) =>
    DisplayConfig(
      ...
      experimentalForceOauthFirst:
          json['experimental_force_oauth_first'] as bool,
      showDevmodeWarning: json['show_devmode_warning'] as bool,
      ...
      instanceEnvironmentType: json['instance_environment_type'] as String?,
      ...
      preferredSignInStrategy: json['preferred_sign_in_strategy'] as String?,
