...
class User {
  ...
  String? get email => _email ??= _persisted(primaryEmailAddressId, emailAddresses);
  String? get phoneNumber => _phoneNumber ??= _persisted(primaryPhoneNumberId, phoneNumbers);
  String? get web3WalletId => _web3WalletId ??= _persisted(primaryWeb3WalletId, web3Wallets);

  set email(String? email) => _email = email;
  set phoneNumber(String? phoneNumber) => _phoneNumber = phoneNumber;
  set web3WalletId(String? web3WalletId) => _web3WalletId = web3WalletId;
